...
<style>
    .backgroundClr{
        background: linear-gradient(0deg, rgba(1, 49, 31, 0.50) 0%, rgba(1, 49, 31, 0.50) 100%), #0D0D0D;
    }
    .memHead{
        color: #C6AA58;
text-align: center;
...
.subBtn{
    background: rgba(198, 170, 88, 0.70);
...
<body class="backgroundClr">
  ...
  <!-- trial period section start --------- -->
  <section class="pt-5">
    <div class="container-fluid pt-5">
        <div class="py-5">
            <h2 class="memHead">Membership Purchase</h2>
            <h1 class="periodHead text-center m-0 p-0"><span class="trialSpan">Unlock Exclusive</span> Benefits With Membership</h1>
             <p class="smallTxt text-center m-0 p-0">In order to avail further great offers, you need to renew your membership</p>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="#">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">First name</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                              
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Last name</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Email address</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Phone number</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Address 1</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Country</label>
                                <select class="form-select  inputClass" aria-label="Default select example">
                                    <option selected class="selectOpt ">Choose country</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">City</label>
                                <select class="form-select  inputClass" aria-label="Default select example">
                                    <option selected class="selectOpt ">Choose city</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                                  </select>                              
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Zip code</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                ...
                <div class="mt-md-5 mt-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-md-between flex-md-row flex-column">
                         <p class="directlyTxt">
                            You can directly pay via "Pay Now" button. You can also pay by bank transfer.
                         </p>
                         <button class="btn payBtn px-5">Pay Now</button>
                        </div>
                    </div>
                </div>
            </div>
