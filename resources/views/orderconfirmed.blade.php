...
<head>
    ...
    <body>
        ...
        <div class="container">
            <div class="check-outsection text-center py-5 tk-img">
            <img src="./assets/img/tik.png" class="img-fluid" alt="">
            <h6 class="pt-5"><span>Order ID:</span> ASD85A</h6>
            <h1>Your  order  has  been  confirmed!</h1>
            <p class="pb-3">Thank you for dining with us.</p>
            <div class="row"><hr class="mx-auto"></div>
            <p>You can keep this Order ID for your records. To print Order details, <a href="#">click here.</a></p>
        </div>

        <div class="d-flex justify-content-center  btn-main m-4 ">
          
          <a href="{{route('checkout')}}">
            <button class="btni m-2" >  <i class="fa-solid fa-arrow-left mx-2   "></i> update order </button>
          </a>
         <a href="{{route('list')}}">
            <button  class="btni m-2" > cancel  order <i class="fa-solid fa-arrow-right mx-2  "></i> </button>
         </a>
        </div>
    </div>
        </div>
