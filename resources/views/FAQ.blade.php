...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark  px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="container-xxl py-5 bg-dark hero-headerthird mb-5">
            <div class="container text-center my-5 pt-5 pb-4 mainsubtext">
                <h1 class="display-3 text-white mb-3 animated slideInDown">FAQ Page</h1>
                <nav aria-label="breadcrumb text-white">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item text1sub"><a href="#">Home</a></li>
                        <li class="breadcrumb-item text2sub"><a href="#">faq</a></li>
    ...
    <div class="main">
         <div class="part2 mt-5"><div class="div3">
            <h3 class="frequent">Frequent Question</h3>
           <div class="d-flex"><h1 class="y-404">Your </h1><h1 style="color: white;" class="ms-2">Queries Here</h1></div> 
          <p class="para3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum, incidunt.</p>
        </div>
        <div class="boxes-div">
            <section class="py-5">
                <div class="container">
                        ...
                        <div class="col-md-6">
                            <div class="accordion accordion-flush" id="faqlist">
                                ...
                                <div class="accordion-item mt-3">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#content-accordion-3">
                                        Is this resturant 24 hours open?
                                        </button>
                                    </h2>
                                    <div id="content-accordion-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                        <div class="accordion-body">
