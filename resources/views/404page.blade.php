...
<body>
              ...
              <div class="container text-center my-5 pt-5 pb-4 mainsubtext">
                  ...
                  <nav aria-label="breadcrumb text-white">
                      <ol class="breadcrumb justify-content-center text-uppercase">
                          ...
                          <li class="breadcrumb-item text2sub"><a href="#">404</a></li>
    ...
    <div class="container-xxl p-0">
        <div class="main">
    <div class="div3 mt-3">
        <h1 class="y-404 heading">404</h1>
        <h4 class="para1">Oops! Look likes something going wrong</h4>
        <div class="para2 mt-3"><p>Page can not be found we will have it figured out in no time.</p>
        <p class="inner-para">Meanwhile, cheek out these fresh ideas:</p></div>
        <button type="button" class="btn btn-outline-warning btn1 mt-3">Go to home</button>
    </div>
    </div>
