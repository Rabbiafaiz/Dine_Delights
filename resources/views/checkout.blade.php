...
<body>
            ...
            <div class="container text-center my-5 pt-5 pb-4 mainsubtext">
                ...
                <nav aria-label="breadcrumb text-white">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        ...
                        <li class="breadcrumb-item text2sub"><a href="#">Shopping Cart</a></li>
    ...
    <div class="container py-5">
        ...
        <div class="row ">
            <div class="col-md-8 col-12 pe-5 ">
                <div class="table-responsive">
                    <table class="table table-hover w-100  ">
                        <thead class="">
                          <tr class=" " >
                            <th class=" pb-5 border border-0 " scope="col"> <h4 class="ss">Product</h4></th>
                            <th class=" pb-5 border border-0" scope="col">  <h4 class="ss">Price</h4></th>
                            <th class=" pb-5 border border-0 px-5" scope="col"> <h4 class="ss">Quantity</h4></th>
                            <th class=" pb-5 border border-0" scope="col"> <h4>Total</h4 class="ss"></th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr  >
                                ...
                                <div class="d-flex flex-column  mx-3 "> <h4  class="hee">Burger</h4> <p>
                                    ...
                                    <span><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.6346 15.0395L14.578 17.5428C15.0866 17.8635 15.7126 17.3863 15.5639 16.7996L14.4215 12.3094C14.3907 12.1849 14.3956 12.0543 14.4357 11.9325C14.4759 11.8107 14.5496 11.7027 14.6484 11.621L18.1851 8.67183C18.6467 8.28852 18.412 7.51407 17.8095 7.47496L13.1931 7.17769C13.0672 7.17037 12.9461 7.12651 12.8446 7.0515C12.7432 6.97648 12.6658 6.87354 12.6219 6.75527L10.9006 2.42148C10.855 2.29624 10.772 2.18805 10.6628 2.1116C10.5536 2.03515 10.4236 1.99414 10.2903 1.99414C10.157 1.99414 10.0269 2.03515 9.91774 2.1116C9.80855 2.18805 9.72555 2.29624 9.67998 2.42148L7.95862 6.75527C7.91475 6.87354 7.83737 6.97648 7.73594 7.0515C7.6345 7.12651 7.5134 7.17037 7.38745 7.17769L2.77108 7.47496C2.1686 7.51407 1.93387 8.28852 2.39551 8.67183L5.93212 11.621C6.03096 11.7027 6.10471 11.8107 6.14485 11.9325C6.185 12.0543 6.18991 12.1849 6.15902 12.3094L5.10273 16.4711C4.92277 17.1751 5.67391 17.7462 6.27639 17.3629L9.94601 15.0395C10.0489 14.9741 10.1683 14.9394 10.2903 14.9394C10.4122 14.9394 10.5316 14.9741 10.6346 15.0395Z" fill="#C6AA58" fill-opacity="0.1" stroke="#C6AA58" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                                </span>
                            ...
                            <td class="py-5" >$35.00</td>
                            <td class="py-5 px-2" >
                                 <span class=" rounded-pill py-0 px-1 d-flex justify-content-center onck h-50 w-lg-50 w-md-100 w-sm-100 ">
                                  <button class="btjs" onclick="increaseNumber()">+</button>
                                <div   class="btjs"  id="number-display">0</div>
                                <button  class="btjs"  onclick="decreaseNumber()">-</button> </span>
                            </td>
                            <td class="py-5" >$62.00</td>
                          ...
                          <tr class="">
                            <th scope="row" class=" py-3 ">
                                <div class="d-flex  ">
                                    <img  class="br1-img img-fluid   "     src="./assets/img/bar2.png" alt="">
                                <div class="d-flex flex-column  mx-3 ">  <h4  class="hee">Fresh Lime</h4> <p>
                            ...
                            <td class="py-5" >$521.00</td>
                          </tr>
                          <tr>
                            <th scope="row" class=" py-3 ">
                                <div class="d-flex  ">
                                    <img  class="br1-img img-fluid   "     src="./assets/img/bar3.png" alt="">
                                <div class="d-flex flex-column mx-3 "> <h4 class="hee">Pizza</h4> <p>
                            ...
                            <td class="py-5" >$421.00</td>
                          </tr>
                          <tr>
                            <th scope="row" class=" py-3">
                                <div class="d-flex  ">
                                    <img  class="br1-img img-fluid   "     src="./assets/img/bar4.png" alt="">
                                <div class="d-flex flex-column  mx-3 "> <h4 class="hee">Chocolate Muffin</h4> <p>
                            ...
                            <td class="py-5" >$44.00</td>
                          </tr>
                          <tr>
                            <th scope="row" class=" py-3">
                                <div class="d-flex  ">
                                    <img  class="br1-img img-fluid  "     src="./assets/img/bar5.png" alt="">
                                <div class="d-flex flex-column  mx-3 "> <h4 class="hee">Cheese Butter</h4> <p>
                            ...
                            <td class="py-5" >$45.00</td>
                            <td class="py-5 px-2" >
                                <span class=" rounded-pill  py-0 px-1 d-flex justify-content-center onck h-50 w-lg-50 w-md-100 w-sm-100 ">
                                 <button class="btjs" onclick="increaseNumber()">+</button>
                               <div   class="btjs"  id="number-display">0</div>
                               <button  class="btjs"  onclick="decreaseNumber()">-</button> </span>
                           </td>                            <td class="py-5" >$62.00</td>
                          </tr>
            ...
            <div class="col-md-4  col-12 cl  p-3 ">


                <h4>Your Order</h4>
                <p>Pay With:</p>

                <div class="container my-2  cn-radio">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input chk-inpt" type="radio" name="exampleRadios" id="radio1" value="option1" checked>
                                <label class="form-check-label lab-radio" for="radio1">card</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="exampleRadios" id="radio2" value="option2">
                                <label class="form-check-label lab-radio" for="radio2">bank</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="exampleRadios" id="radio3" value="option3">
                                <label class="form-check-label lab-radio" for="radio3">cash</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form>
                    <div class="mb-4 ">
                      <label for="exampleInputEmail1" class="form-label f1">card number</label>
                      <input type="text" class=" f2 form-control" id="exampleInputEmail1 f2" aria-describedby="emailHelp">

                    </div>
                    <div class="mb-4">
                      <label for="exampleInputPassword1" class="form-label f1">Expiration Date</label>
                      <input type="text" class="form-control f2" id="exampleInputPassword1">
                    </div>
                    <div class="mb-4">
                        <label for="exampleInputPassword1" class="form-label f1">CSV</label>
                        <input type="text" class="form-control f2" id="exampleInputPassword1">
                      </div>
                      <div class="hrf"></div>
                      <div class="min1 d-flex justify-content-between py-2">
                        <div class="d1f">
                            <p>Sub-total</p>
                            <p>shipping</p>
                            <p>Discount</p>
                      ...
                      <div class="para" ><p>Total</p> </div>
                       <div  class="para"><P> 432.65$</P></div>
                      </div>
                     <a href="{{route('confirm')}}">
                        <div class="d-flex justify-content-center p-4 btn1">
                            <button class="btn  btn-place " type="button">place an order<i class="fa-solid fa-arrow-right p-2"></i></button>
                          </div>
