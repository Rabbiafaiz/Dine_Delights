...
<head>
    ...
    <style>
        ...
        @media (max-width:504px){
            ...
            .icon1, .para5, .para6 , .para7, .para8, .bold-para{
                font-size: 10px;
            }
            .main-img{
            width: auto;
                ...
                <div class="container text-center my-5 pt-5 pb-4 mainsubtext">
                    ...
                    <nav aria-label="breadcrumb text-white">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item text1sub"><a href="{{route('blogdetails')}}">Home</a></li>
    ...
    <div class="main-div container-fluid">
        <div class="row p-5 m-0 p-0">
            <div class="col-lg-8 col-12">
                <div class="card" style=" background-color: rgb(7,31,22);">
                    <img class="card-img" src="./assets/img/img-1.png" alt="Card image cap">
                    <div class="card-body">
                        <div class="d-flex"><i class="fa-regular fa-calendar icon" style="color: #FFD43B;"></i>
                        <p class="para4 ms-1"> Feb 14,2022  </p> <p class="para4"> / </p> <i class="fa-regular fa-message icon ms-1" style="color: #FFD43B;"></i> <p class="para4 ms-1"> 3</p> <p class="para4 ms-1">/</p> <i class="fa-solid fa-person-circle-plus icon ms-1" style="color: #FFD43B;"></i><p class="para4 ms-1">admin</p> </div>
                      <h5 class="card-title title">10 Reasons to do a detox challenge</h5>
                      <p class="card-text text bor-top">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, aliquid quas. Rerum impedit ducimus ut magni nostrum omnis libero dolores cupiditate dolor laborum nulla aut velit accusantium quos perferendis vero accusamus reiciendis nemo quo quod, odit eum inventore laboriosam? Accusamus deserunt</p>
                      <p class="card-text text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, aliquid quas. Rerum impedit ducimus ut magni nostrum omnis libero dolores cupiditate dolor laborum nulla aut velit accusantium quos perferendis vero accusamus reiciendis nemo quo quod, odit eum inventore laboriosam? Accusamus deserunt</p>
                    </div>
                  </div>
                  <div class="div5 mt-3 p-2">
                    <div><i class="fa-solid fa-quote-left float-start" style="color: white;"></i><p class="ms-4 bold-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. </p></div>
                  </div>
                  <div class="div6">
                    <p class="para5">Lorem ipsum  adipisicing elit. Ducimus error alias quis numquam ea. Dolorum velit dolor et ipsa molestias unde quibusdam consectetur veniam sunt itaque repellat corrupti iste eligendi aut commodi incidunt, quis harum quia vel vero odit deleniti nulla obcaecati. At eum accusamus itaque earum, adipisci veritatis perferendis!</p>
                 <div class=" m-0 p-0">
                  <p class="para6">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nostrum unde dolore earum asperiores sint ipsum, ut magni, quisquam aut dignissimos libero non blanditiis vero sapiente repellendus numquam corrupti ratione ipsa quae! Unde fugit corrupti non fuga atque aliquid veritatis commodi ab molestias tempore, temporibus hic quidem nihil natus sit nam laborum nemo architecto ratione consequuntur aspernatur quaerat cum? Consequuntur impedit placeat unde pariatur velit amet labore quasi modi quae suscipit perspiciatis mollitia quibusdam, id inventore? Voluptatum excepturi nam eos. Esse reprehenderit eos corrupti quos odio minima explicabo. Dolor sit suscipit assumenda modi quasi. Ea repellendus vel aliquid, at totam pariatur.</p>
                  <img src="./assets/img/main-img.png" alt="" class=" img-fluid main-img" style="float: right;"></div>
                  <p class="mt-2 para8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis eaque est assumenda vitae sapiente iusto minima provident dicta inventore nihil harum aut necessitatibus aperiam itaque nisi ad molestiae similique pariatur ipsa enim, tempore minus maiores! Illum maxime, vel earum ad enim ratione natus ipsum officia. Nobis eos eaque saepe ducimus debitis unde sequi iure neque. Libero nemo minima dolore expedita unde facere, vel pariatur enim maxime quia error sit? Sapiente, eaque pariatur? Suscipit exercitationem magnam ea voluptatem, commodi quisquam debitis quam molestias totam optio voluptate deserunt, nostrum accusantium? Fugit quia fugiat nesciunt nemo, dolorum odit? Laborum labore adipisci quam beatae!</p>
               <p class="para7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus corporis deserunt quam blanditiis totam, ut fuga quas asperiores, sapiente in autem cum veritatis. Labore asperiores, officiis obcaecati recusandae id architecto iure, officia error distinctio inventore, ut quos pariatur enim sed? Aut labore natus provident voluptatibus! Sequi consequatur, sed et quo laboriosam labore quaerat iure repudiandae distinctio. Repudiandae ab expedita hic eum quos excepturi optio qui quisquam nihil culpa nam debitis, aliquam, voluptatem adipisci dicta corporis accusamus? Enim mollitia consequatur explicabo delectus inventore! Autem maiores fugiat accusamus dignissimos voluptatem incidunt in nulla cupiditate? Ratione, numquam recusandae dolore quisquam corrupti atque magni?</p>
                </div>
                <div class="div7 container-fluid row justify-content-between">
                   <div class="col-lg-6"><h5 style="color: white;" class="d-inline h5">Tags: </h5>
                    <p class="d-inline tags">Restraunt,dinner,Pizza,Yummy,</p></div>
                    <div class=" col-lg-6 "><h5 style="color: white;" class="d-inline h5">Share:</h5>
                       <i class="fa-brands fa-facebook ms-1 icon1" style="color: #ffffff;" class="d-inline"></i>
                        <i class="fa-brands fa-twitter ms-1 icon1" style="color: #ffffff;" class="d-inline"></i>
                        <i class="fa-brands fa-instagram ms-1 icon1 " style="color: #ffffff;" class="d-inline"></i>
                        <i class="fa-brands fa-pinterest ms-1 icon1" style="color: #ffffff;" class="d-inline"></i>
                    </div>
                </div>
                <div class="div8 container-fluid mt-3">
                    <h2 class="heading d-inline comments">Comments</h2> <h2 class="ms-1 heading d-inline comments">-</h2><h2 class="ms-1 heading d-inline comments">03</h2>
                <div class="divA mt-5 row m-0 p-0">
                    <img src="./assets/img/Mask Group.png" alt="" class="col-2 dp">
                    <div class="comment col-10"><p class="heading d-inline md">MD Sojib Khan</p> <p class="d-inline ms-4 rep" style="color: #FFD43B;"> <svg width="18" height="18" class="svg" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.80271 10.6875L2.51367 7.3125L5.80271 3.9375" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.09177 10.6875L5.80273 7.3125L9.09177 3.9375" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.6698 14.0625C15.6698 12.2723 14.9768 10.5554 13.7432 9.28953C12.5095 8.02366 10.8364 7.3125 9.09177 7.3125H5.80273" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                         Reply</p>
                        <p style="font-size: 10px;">Jan 22,2020</p>
                    <p class="para6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt recusandae dolor earum saepe molestiae nesciunt?</p></div>
                </div>
                <div class="divA mt-5 row ms-5 p-0">
                    <img src="./assets/img/Mask Group2.png" alt="" class="col-2 dp">
                    <div class="comment col-10"><p class="heading d-inline md">MD Sojib Khan</p> <p class="d-inline ms-4 rep" style="color: #FFD43B;"> <svg width="18" height="18" class="svg" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.80271 10.6875L2.51367 7.3125L5.80271 3.9375" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.09177 10.6875L5.80273 7.3125L9.09177 3.9375" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.6698 14.0625C15.6698 12.2723 14.9768 10.5554 13.7432 9.28953C12.5095 8.02366 10.8364 7.3125 9.09177 7.3125H5.80273" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="divA mt-5 row m-0 p-0">
                    <img src="./assets/img/Mask Group3.png" alt="" class="col-2 dp">
                    <div class="comment col-10"><p class="heading d-inline md">MD Sojib Khan</p> <p class="d-inline ms-4 rep" style="color: #FFD43B;"> <svg width="18" class="svg" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.80271 10.6875L2.51367 7.3125L5.80271 3.9375" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.09177 10.6875L5.80273 7.3125L9.09177 3.9375" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.6698 14.0625C15.6698 12.2723 14.9768 10.5554 13.7432 9.28953C12.5095 8.02366 10.8364 7.3125 9.09177 7.3125H5.80273" stroke="#C6AA58" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                ...
                <div class="div9">
                    <h2 class="heading">Post a Feedback</h2>
                    <div class="internal">
                        <div class="row m-0 p-0 gy-4">
                            <div class="col">
                              <input type="text" class="form-control" placeholder="Name*" aria-label="First name" style="background-color: transparent;">
                            </div>
                            <div class="col">
                              <input type="text" class="form-control" placeholder="Email" aria-label="Email" style="background-color: transparent;">
                            </div>
                          </div>
                          <div class="row m-0 p-0 gy-4">
                          <div class="form-floating">
                            <textarea class="form-control" placeholder="" id="floatingTextarea2" style="height: 150px; overflow-y:auto; background-color: transparent;" ></textarea>
                            <label for="floatingTextarea2">Write a comment</label>
                          </div>
                        </div>
                        <button type="button" class="btn btn-outline-warning mt-3 ms-3" style="border-radius: 10px;">Send feedback</button>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-12">
                <div class="input-group" >
                  ...
                  <div class="card mt-4" style="background-color: transparent; border-color: white;" >
                    ...
                    <i class="fa-brands fa-facebook ms-1" style="color: #ffffff;"></i>
                            <i class="fa-brands fa-twitter ms-1" style="color: #ffffff;"></i>
                            <i class="fa-brands fa-instagram ms-1 " style="color: #ffffff;"></i>
                            <i class="fa-brands fa-pinterest ms-1" style="color: #ffffff;"></i>
                    </div>
                  </div>
