...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* sign in and sign up page css start ---------------- */
      .formBg {
        border-radius: 6px;
...
.googleMargin{
    margin-top: 100px !important;
      ...
      /* sign in page and sign up css end ---------------- */
        ...
        <nav class="navbar navbar-expand-lg navbar-dark  px-4 px-lg-5 py-3 py-lg-0">
          ...
          <div class="container-xxl py-5 bg-dark hero-headerthird mb-5">
              <div class="container text-center my-5 pt-5 pb-4 mainsubtext">
                  <h1 class="display-3 text-white mb-3 animated slideInDown">Sign up page</h1>
                  <nav aria-label="breadcrumb text-white">
                      <ol class="breadcrumb justify-content-center text-uppercase">
                          <li class="breadcrumb-item text1sub"><a href="#">Home</a></li>
                          <li class="breadcrumb-item text2sub"><a href="#">sign up</a></li>
    ...
    <section class="backgroundClr">
      <div class="container-fluid mt-5">
        <div class="row">
          ...
          <div class="col-md-4">
            <form action="{{route('signup')}}" class="formBg   px-3 pt-3 pb-5">
              <h1 class="signHead my-4">Sign Up</h1>
              ...
              <div class="mb-3 d-flex inDiv">
                <img
                  class="envImg mx-1"
                  src="./assets/img/EnvelopeSimple.png"
                  alt=""
                />
                <input
                  type="email"
              ...
              <div class="mb-3 d-flex inDiv">
                <img class="envImg mx-1" src="./assets/img/Lock.png" alt="" />
                <input
                  type="email"
                  class="py-3 inTag"
                  aria-describedby="emailHelp"
              ...
              <div class="form-check">
                ...
                />
                <label
                  class="form-check-label rememberLabel"
              ...
              <button class="btn signinBtn w-100 my-4 py-2">Sign Up</button>
