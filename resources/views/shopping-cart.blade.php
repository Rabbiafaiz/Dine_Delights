...
<body>
    ...
    <div class=" container-fluid  p-5">
                    ...
                    <table class="table table-hover w-100  ">
                        <thead class="">
                            <tr class=" ">
                                ...
                                <th class=" pb-5 border border-0" scope="col">
                                    <h4>Total</h4 class="ss">
                                </th>
                                <th class=" pb-5 border border-0 ps-5" scope="col">
                                    <h4>Modify Order</h4 class="ss">
                                </th>
                                <th class=" pb-5 border border-0 ps-5" scope="col">
                                    <h4>Remove</h4 class="ss">
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-5 px-2">
                                    <span
                                        class=" rounded-pill py-0 px-1 d-flex justify-content-center onck h-50 w-lg-50 w-md-100 w-sm-100 ">
                                        <button class="btjs" onclick="increaseNumber()">+</button>
                                        <div class="btjs" id="number-display">0</div>
                                        <button class="btjs" onclick="decreaseNumber()">-</button>
                                    </span>
                                </td>
                                <td class="py-5">Mark</td>
                                <td class=" text-center  py-5 "><img class="" src="./assets/img/edit 1.svg" alt=""></td>
                                <td class=" text-center  py-5"><img src="./assets/img/X.svg" alt=""></td>
                            ...
                            <tr>
                                <th scope="row" class=" py-3">
                                    <div class="d-flex  ">
                                        ...
                                        <div class="d-flex flex-column  mx-3 ">
                                            <h4 class="hee">Chocolate Muffin</h4>
                                            <p>
        ...
        <div class="container">
            <div class="row d-flex flex-md-row  flex-column-reverse mt-5 ">
                <div class="col-12 col-md-6">
                    <h1 class=" mt-4 mt-md-0"> Coupon Code</h1>l

                    <div class="border-container">
                        <p class="">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis in adipisci laboriosam
                            ut temporibus porro dolorem officia cum ratione impedit!
                        </p>
                        <div class="input-group custom-border">
                            <input type="text " class="form-control coupon-input-field" placeholder="Enter Here Code">
                            <button class="btn custom-border apply-btn " type="button">Apply</button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6  ">
                    <h1 class=" mt-4 mt-md-0 "> Total Bill</h1>
                    <div class="table-responsive custom-table-border mt-4 ">
                        <table class=" table table-borderless  ">

                            <tbody class=" ">
                                <tr class=" ">
                                    <td class="table-text-design text-white fw-bold  py-3 ">Cart Subtotal</td>
                                    <td class=" table-text-design text-white text-end fw-bold  py-3   ">$120.00</td>
                                </tr>
                                <tr>
                                    <td class="table-text-design py-3 normal-color">Shipping Charge</td>
                                    <td class="text-end table-text-design  py-3 normal-color">$00.00</td>
                                </tr>
                                <tr>
                                    <td class="table-text-design fw-bold  py-3 gold-color">Discount</td>
                                    <td class="text-end fw-bold gold-color py-3">$00.00</td>
                                </tr>
                                <tr class="border-top py-3">
                                    <td class="table-text-design fw-bold py-3 text-white  ">Total Amount</td>
                                    <td class="text-end text-white fw-bold py-3 ">$205.00</td>
                                </tr>
                            </tbody>
                        </table>

                    </div>
                    <div class="d-flex justify-content-center my-3 btn1">
                     <a href="{{route('checkout')}}" class="w-100">
                        <button class="btn  btn-place w-100" type="button">place an order<i class="fa-solid fa-arrow-right p-2"></i></button>
                     </a>
                      </div>
                </div>
