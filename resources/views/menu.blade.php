       ...
       <nav class="navbar navbar-expand-lg navbar-dark  px-4 px-lg-5 py-3 py-lg-0">
         ...
         <div class="container-xxl py-5 bg-dark hero-headerthird mb-5">
             <div class="container text-center my-5 pt-5 pb-4 mainsubtext">
                 <h1 class="display-3 text-white mb-3 animated slideInDown">Menu page</h1>
                 <nav aria-label="breadcrumb text-white">
                     <ol class="breadcrumb justify-content-center text-uppercase">
                         <li class="breadcrumb-item text1sub"><a href="#">Home</a></li>
                         <li class="breadcrumb-item text2sub"><a href="#">sign Ip</a></li>
...
@endif
        ...
        <div class="container mt-5 ">
            <div class="row my-md-5 ">
                <div class="col-lg-4  ">
                    <div class="left mb-lg-0 ">
                        <img class="w-100" src="./assets/img/karahi.png" alt="">
                    </div>
                </div>
                <div class="col-lg-1 "></div>
                <div class="col-lg-7   my-4 my-lg-0   ">
                    <div class="right">
                        <img class="coffee mb-3 " src="./assets/img/Coffee.png" alt="">
                        <div class="right2 d-flex justify-content-between  align-items-center ">
                            <h2>Starter Menu</h2>
                            <div class="more">
                                {{-- <button class="btn-more">See More</button> --}}
                            <a href="{{ route('cart') }}" class="btn-more">Add to cart</a>

                            </div>
                        </div>
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Alder Grilled Chinook Salmon</h3>
                                <p class="toasted mt-3">Toasted French bread topped with romano, cheddar</p>
                                <p class="numbr">560 CAL</p>
                            </div>
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Berries and creme tart</h3>
                                <p class="toasted mt-3">Gorgonzola, ricotta, mozzarella, taleggio</p>
                                <p class="numbr">700 CAL</p>
                            </div>
                            <div class="content-pp ">
                                <p>43$</p>
                            </div>
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Tormentoso Bush Pizza Pintoage</h3>
                                <p class="toasted mt-3">Ground cumin, avocados, peeled and cubed</p>
                                <p class="numbr">1000 CAL</p>
                            </div>
                            <div class="content-pp ">
                                <p>14$</p>
                            </div>
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Spicy Vegan Potato Curry</h3>
                                <p class="toasted mt-3">Spreadable cream cheese, crumbled blue cheese</p>
                                <p class="numbr">560 CAL</p>
                            </div>
                            <div class="content-pp ">
                                <p>35$</p>
            ...
            <div class="row my-md-5 ">
                <div class="col-lg-7   my-4 my-lg-0   ">
                    <div class="right">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Cashew Chicken With Stir-Fry</h3>
                                <p class="toasted mt-3">Gorgonzola, ricotta, mozzarella, taleggio</p>
                                <p class="numbr">700 CAL</p>
                            </div>
                            <div class="content-pp ">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class=""> Vegetables & Green Salad</h3>
                                <p class="toasted mt-3">Ground cumin, avocados, peeled and cubed</p>
                                <p class="numbr">1000 CAL</p>
                            </div>
                            <div class="content-pp ">
                ...
                <div class="col-lg-4  ">
                    <div class="left mb-lg-0 ">
                        <img class="w-100" src="./assets/img/unsplash.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--#############> Deliver Banner End <############-->
        ...
        <div class="container mt-5 ">
            <div class="row my-md-5 ">
                <div class="col-lg-4  ">
                    <div class="left mb-lg-0 ">
                        <img class="w-100" src="./assets/img/icream.png" alt="">
                    </div>
                </div>
                <div class="col-lg-1 "></div>
                <div class="col-lg-7   my-4 my-lg-0   ">
                    <div class="right">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Fig and lemon cake</h3>
                                <p class="toasted mt-3">Toasted French bread topped with romano, cheddar</p>
                                <p class="numbr">560 CAL</p>
                            </div>
                            <div class="content-pp ">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Creamy mascarpone cake</h3>
                                <p class="toasted mt-3">Gorgonzola, ricotta, mozzarella, taleggio</p>
                                <p class="numbr">700 CAL</p>
                            </div>
                            <div class="content-pp ">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Pastry, blueberries, lemon juice</h3>
                                <p class="toasted mt-3">Ground cumin, avocados, peeled and cubed</p>
                                <p class="numbr">1000 CAL</p>
                            </div>
                            <div class="content-pp ">
            ...
            <div class="row my-md-5 ">
                <div class="col-lg-7   my-4 my-lg-0   ">
                    <div class="right">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Aperol Spritz Capacianno</h3>
                                <p class="toasted mt-3">Gorgonzola, ricotta, mozzarella, taleggio</p>
                                <p class="numbr">700 CAL</p>
                            </div>
                            <div class="content-pp ">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class=""> Caffe Latte Campuri</h3>
                                <p class="toasted mt-3">Ground cumin, avocados, peeled and cubed</p>
                                <p class="numbr">1000 CAL</p>
                            </div>
                            <div class="content-pp ">
                        ...
                        <div class="my-3 d-flex justify-content-between ">
                            <div class="content-p  ">
                                <h3 class="">Tormentoso BushTea Pintoage </h3>
                                <p class="toasted mt-3">Spreadable cream cheese, crumbled blue cheese</p>
                                <p class="numbr">560 CAL</p>
                            </div>
                            <div class="content-pp ">
                ...
                <div class="col-lg-1 "></div>
                <div class="col-lg-4  ">
                    <div class="left mb-lg-0 mb-md-3  ">
                        <img class="w-100" src="./assets/img/icecream.png" alt="">
                    </div>
                </div>
            </div>

        </div>
        <div class="tyext my-5 ">
            <p class="text-center contant-ppp ">Partners & Clients</p>
            <h2 class="text-center contant-ppp2 pt-3 ">We work with the best pepole</h2>
        </div>
        <div class="container mt-4 ">
            <div class="row">
                <div class="col-md-2 col-4 ">
                    <img class="w-75  " src="./assets/img/image-six.png" alt="">
                </div>
                <div class="col-md-2 col-4 ">
                    <img class="w-75  " src="./assets/img/image-five.png" alt="">
                </div>
                <div class="col-md-2 col-4 ">
                    <img class="w-75  " src="./assets/img/image-fourth.png" alt="">
                </div>
                <div class="col-md-2 col-4 ">
                    <img class="w-75  " src="./assets/img/image-thirld.png" alt="">
                </div>
                <div class="col-md-2 col-4 ">
                    <img class="w-75  " src="./assets/img/image-second.png" alt="">
                </div>
                <div class="col-md-2 col-4 ">
                    <img class="w-75  " src="./assets/img/image-resturent.png" alt="">
                </div>
            </div>
        </div>
