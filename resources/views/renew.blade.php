  ...
  <section class="pt-5 ">
    <div class="container-fluid pt-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="py-5">
                    <h2 class="memHead">Membership Renewal</h2>
                    <h1 class="periodHead text-center m-0 p-0"><span class="trialSpan">Renew & Reap</span> Membership Benefits </h1>
                ...
                <form action="./purchase.html">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Membership ID</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Payment</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-12 py-3">
                            ...
                            <div class="d-flex">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label  cardClr" for="exampleRadios1">
                                        Card
                                    </label>
                                  </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Card Number</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">Expiration Date</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label labelClass">CSV</label>
                                <input type="email" class="form-control inputClass" id="exampleFormControlInput1"  >
                              </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <button  class="btn proceedBtn px-5 py-2 my-4">
                                Proceed to Checkout <img class="proceedImg" src="./img/proceedImg.png" alt="">
                            </button>
